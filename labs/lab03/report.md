...
model pr
  ...
  Real y11(start=331000);
  Real y21(start=225000);
  ...
  Real y12(start=331000);
  Real y22(start=225000);
  parameter Real a2(start = 0.225);
  parameter Real b2(start = 0.774);
  parameter Real c2(start = 0.331);
  parameter Real h2(start = 0.665);
  
  equation
    der(y11) = -a*y11 - b*y21 + abs(cos(2*time));
    der(y21) = -c*y11 - h*y21 + abs(sin(2*time));
    
  equation
    der(y12) = -a*y12 - b*y22 + abs(sin(2*time)+1);
    der(y22) = -c*y12*y22 - h*y22 + cos(2*time) + 1;  

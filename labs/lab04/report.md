...
subtitle: "Модель гармонических колебаний - вариант 68"
...
силы $\ddot{x}+0.5\dot{x}+5x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+5\dot{x}+0.5x=0.5\cos{5t}$

На итнтервале $t \in [ 0;55 ]$, шаг 0.05, $x_0=-0.5, y_0=0.5$

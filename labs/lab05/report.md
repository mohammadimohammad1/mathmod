...
subtitle: "Модель хищник-жертва - вариант 68"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.64x(t) + 0.056y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.46y(t) - 0.054y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=8, y_0=27$
...
parameter Real b = 0.056;
parameter Real c = 0.46;
parameter Real d = 0.054;
...
Стационарное состояние $x_0=\frac{a}{b}=11.429, y_0=\frac{c}{d}=8.519$

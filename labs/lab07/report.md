...
subtitle: "Модель распространения рекламы - вариант 68"
...
1.	$\frac{dn}{dt} = (0.385 + 0.000014n(t))(N-n(t))$
2.	$\frac{dn}{dt} = (0.000014 + 0.15n(t))(N-n(t))$
3.	$\frac{dn}{dt} = (0.16\sin{t} + 0.18\cos{t} t n(t))(N-n(t))$

При этом объем аудитории $N = 1172$, в начальный момент о товаре знает 2 человек.

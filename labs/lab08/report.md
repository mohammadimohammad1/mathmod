...
subtitle: "Модель конкуренции двух фирм - вариант 68"
...
$$\frac{dM_1}{d\Theta} = M_1 - (\frac{b}{c_1} + 0.00068)M_1 M_2 - \frac{a1}{c1} M_1^2 $$
...
$$ p_{cr}=38 \: N=40 \: q=1 $$
$$ \tau_1=19 \: \tau_2=25 $$
$$ \widetilde{p}_1=12.5 \: \widetilde{p}_2=8.9 $$
...
parameter Real p2=8.9;

parameter Real d=0.00068;
